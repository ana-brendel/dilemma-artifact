...
(* Theorem mult_qexp  *)
Theorem goal35_by_mult_assoc_1 : forall (x y z a : Nat), mult (qexp x y z) a = qexp x y (mult z a).
Proof.
  intros x y.
  induction y.
  - intros. simpl. rewrite IHy. 
  dilemma. Admitted.
  (* rewrite mult_assoc. rewrite (mult_commut x a). rewrite <- mult_assoc. reflexivity.
  - reflexivity.
Qed. *)
