...
Theorem goal56_by_drop_succ_1 : forall (v : Nat) (w : Nat) (x : Nat) (y : Nat) (z : Lst), eq (drop (succ v) (drop w (drop x (cons y z)))) (drop v (drop w (drop x z))).
Proof.
intros. 
dilemma. Admitted.
(* rewrite drop_succ. rewrite drop_succ. reflexivity.
Qed. *)
