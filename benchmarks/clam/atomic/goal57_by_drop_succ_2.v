...
Theorem goal57_by_drop_succ_2 : forall (u : Nat) (v : Nat) (w : Nat) (x : Nat) (y : Nat) (z : Lst),
  eq (drop (succ u) (drop v (drop (succ w) (cons x (cons y z))))) (drop (succ u) (drop v (drop w (cons x z)))).
Proof.
intros. rewrite drop_succ. 
dilemma. Admitted.
(* rewrite drop_succ. rewrite drop_succ. rewrite drop_succ. reflexivity.
Qed. *)
