...
Theorem goal20_by_even_odd_append_len : forall (x : Lst) (y : Lst), eq (even (len (append x y))) (even (len (append y x))).
Proof.
induction x.
  ...
  (* rewrite <- even_odd_append_len. f_equal. rewrite IHx. reflexivity.
Qed. *)
